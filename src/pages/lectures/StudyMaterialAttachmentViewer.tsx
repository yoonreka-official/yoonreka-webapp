...
export interface StudyMaterialAttachmentViewerProps {
  attachment: AttachmentFile
}

export function StudyMaterialAttachmentViewer({
  attachment,
}: StudyMaterialAttachmentViewerProps) {
    ...
    <>
      <div css={styles.pdfViewerWrapper}>
        ...
        >
          ...
          <Flex css={styles.controller} items="center" justify="space-between">
            <Flex gap={4}>
              <button
